                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-check form-switch toggle-switch">
                                                <input class="form-check-input custome" type="checkbox" id="flexSwitchCheckChecked1"
                                                    checked="">
                                            ...
                                            <div class="form-check form-switch toggle-switch">
                                                <input class="form-check-input custome" type="checkbox" id="flexSwitchCheckChecked2"
                                                    checked="">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-xl-6 col-sm-6">
                                                <div class=" owl-carousel card-slider">
                                                    <div class="items">
                                                        ...
                                                        <span class="fs-14 font-w400">Sed ut perspiciatis unde omnis iste natus error sit
                                    ...
                                    <div class="col-xl-6 col-xxl-12 col-sm-6">
                                        <div class="card">
                                            ...
                                            <div class="card-footer border-0 pt-0">
                                                <a href="javascript:void(0);" class="btn btn-outline-primary d-block btn-rounded">Update
                                                    Progress</a>
                                            </div>
                                        </div>
                                    </div>
