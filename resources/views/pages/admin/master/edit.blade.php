                ...
                <form action="{{ route('admin.master.update', $master->id) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <input name="created_at" class="form-control mb-3" value="{{ $master->created_at }}" type="text" id="created_at">
                        </div>
                        <div class="col-12">
                            <label for="updated_at" class="form-label">Updated At</label>
                            <input name="updated_at" class="form-control mb-3" value="{{ $master->updated_at }}" type="text" id="updated_at">
                        </div>
                        <div class="col-12">
